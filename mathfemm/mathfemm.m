...
MISetPrevious::usage = "MISetPrevious[\"filename\"] defines the previous solution to be used as the basis for an AC incremental permeability solution.  The filename should include the .ans extension"
...
SmartMesh::Usage = "SmartMesh[state] sets Smart Meshing on if state=1 or off if state=0"
...
SmartMesh[n_]:=MLPut["smartmesh(" <> Num[fn] <> ")"];
